...
import { getOrganizationMemberById } from 'apiSdk/organization-members';
...
function OrganizationMemberViewPage() {
      ...
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          <Text as="h1" fontSize="2xl" fontWeight="bold">
            Organization Member Detail View
          </Text>
          {hasAccess('organization_member', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/organization-members/edit/${data?.id}`} passHref legacyBehavior>
              <Button
